...
namespace Designer
{
    public static class StylePresets
    {
        ...
        public static GUIStyle GetCustomLabel(Color color, int fontSize = 14, TextAnchor anchor = TextAnchor.MiddleCenter, FontStyle fontStyle = FontStyle.Normal)
        {
            ...
            _customLabel.fontStyle = fontStyle;
